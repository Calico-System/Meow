...
astsbindir => /usr/sbin
"""
        with open(os.path.join(ASTERISK_CONFIG_DIR, "asterisk.conf"), "w") as f:
        ...
        sip = f"""; Auto-generated by fetch.py — do not edit manually

[general]
context=calico
bindport={ASTERISK_SIP_PORT}
bindaddr=0.0.0.0
...
allow=alaw
{ext_blocks}"""
        with open(os.path.join(ASTERISK_CONFIG_DIR, "sip.conf"), "w") as f:
            f.write(sip)
...
"""
        with open(os.path.join(ASTERISK_CONFIG_DIR, "extensions.conf"), "w") as f:
            f.write(ext_conf)
...
"""
        with open(os.path.join(ASTERISK_CONFIG_DIR, "rtp.conf"), "w") as f:
            f.write(rtp)
...
noload => res_fax.so
"""
        with open(os.path.join(ASTERISK_CONFIG_DIR, "modules.conf"), "w") as f:
            f.write(modules)
...
write=all
"""
        with open(os.path.join(ASTERISK_CONFIG_DIR, "manager.conf"), "w") as f:
            f.write(manager)
